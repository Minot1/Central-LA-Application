      ...
      <TableRow>
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={4}>
          <Collapse in={open} component="tr" style={{ display: "block" }}>
            <td>
              <Typography m={2}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget augue tincidunt,
                tincidunt nunc eu, pulvinar sem. Nunc non lobortis metus. Nulla a ligula ac nisl
                vulputate auctor eu sed orci. Praesent a augue ut urna laoreet euismod. Duis non
                nulla fermentum eros scelerisque pharetra. Maecenas id suscipit purus. Mauris vel
                metus et arcu imperdiet suscipit in vitae arcu. Aenean tellus risus, ultricies ut
                risus nec, faucibus laoreet libero. Vestibulum nec tempus orci, sagittis pretium
                tortor. Etiam quis mattis ante, sed efficitur eros. In imperdiet turpis magna, in
                viverra velit varius sed. Nulla mollis lobortis aliquet. Nullam viverra et enim quis
                ullamcorper. Sed tincidunt tellus vitae ligula tincidunt, eu molestie metus
                interdum.
              </Typography>
            </td>
          </Collapse>
